# Blue team scores
kill @e[predicate=aethel_event:minigame/creeperball/stadium/nets/red]
scoreboard players add SDUBlue Creeperball 1
...
execute as @a[predicate=aethel_event:minigame/creeperball/stadium/zones/event] run tellraw @s [{"text":"Blue: ","color":"dark_blue"},{"score":{"name":"SDUBlue","objective":"Creeperball"},"color":"white"},{"text":" | ","color":"gray"},{"text":"Red: ","color":"red"},{"score":{"name":"SDURed","objective":"Creeperball"},"color":"white"}]
