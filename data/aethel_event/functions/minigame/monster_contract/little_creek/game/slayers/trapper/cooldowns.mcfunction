...
execute store result score LCTrappers# MonsterContract run execute if entity @a[predicate=aethel_event:minigame/monster_contract/little_creek/zones/play,tag=MonsterContractTrapper]
execute store result score LCTrappersEPSA# MonsterContract run clear @a[predicate=aethel_event:minigame/monster_contract/little_creek/zones/play,tag=MonsterContractTrapper] crossbow{Damage: 464} 0
execute store result score LCTrappersBT# MonsterContract run clear @a[predicate=aethel_event:minigame/monster_contract/little_creek/zones/play,tag=MonsterContractTrapper] tripwire_hook 0
