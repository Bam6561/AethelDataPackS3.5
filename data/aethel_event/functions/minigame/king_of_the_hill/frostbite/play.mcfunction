# Loadouts
execute as @a[predicate=aethel_event:minigame/king_of_the_hill/frostbite/zones/play,scores={TimeSinceDeath=..5}] run function aethel_event:minigame/king_of_the_hill/frostbite/game/loadout
