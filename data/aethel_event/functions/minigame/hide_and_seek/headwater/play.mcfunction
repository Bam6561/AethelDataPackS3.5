...
execute as @a[tag=Tagged,predicate=aethel_event:minigame/hide_and_seek/headwater/zones/play] run function aethel_event:minigame/hide_and_seek/headwater/game/tagged_hider
