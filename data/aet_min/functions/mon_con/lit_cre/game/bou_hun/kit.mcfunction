# Weapon
item replace entity @s hotbar.0 with fishing_rod{display: {Name: '[{"text":"Hook","italic":false,"color":"white"}]'}, AttributeModifiers: [{AttributeName: "generic.attack_damage", Amount: 9.5d, Slot: mainhand, Name: "generic.attack_damage", UUID: [I; -123323, 29652, 194348, -59304]}, {AttributeName: "generic.attack_speed", Amount: -0.4d, Slot: mainhand, Operation: 1, Name: "generic.attack_speed", UUID: [I; -123323, 29752, 194348, -59504]}], Enchantments: [{id: "vanishing_curse", lvl: 1}], Unbreakable: 1b}
