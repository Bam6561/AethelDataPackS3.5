give @p diamond_helmet{Enchantments:[{id:"vanishing_curse",lvl:1},{id:"unbreaking",lvl:3},{id:"protection",lvl:1}]} 1
give @p diamond_chestplate{Enchantments:[{id:"vanishing_curse",lvl:1},{id:"unbreaking",lvl:3},{id:"protection",lvl:1}]} 1
